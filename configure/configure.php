...
function gtm_head() {
	if ($analytics = get_field('analytics', 'options')):
		if ($analytics['google_tag_manager_header']) {
			echo $analytics['google_tag_manager_header'];
		}
	endif;
	return;
}
...
function gtm_body() {
	if ($analytics = get_field('analytics', 'options')){
		if ($analytics['google_tag_manager_body']) {
			echo $analytics['google_tag_manager_body'];
		}
	}
	return;
}